...
{
	printf("%d. Intrarea la galeria %s consta %.2f \n", g.cod, g.nume, g.pretIntrare);
}
...
void afisareTablea(HashTable tabela)
{
...
void main()
{
	...
	Galerie g3=initGalerie(3,"Antipa",20);
	...
	afisareTablea(tabela);
	Galerie g = cautaGalerieDupaCheie(3, "Antipa", tabela);
	printf(" Cautare: \n");
	afisareGalerie(g);
}